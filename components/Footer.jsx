        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://www.instagram.com/sarahdabancens/" target="_blank" rel="noopener noreferrer" aria-label="Instagram SD Équicoaching" className="text-white/50 hover:text-or transition-colors"><Instagram className="w-5 h-5" /></a>
              <a href="https://www.linkedin.com/in/sarah-dabancens/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Sarah Dabancens" className="text-white/50 hover:text-or transition-colors"><Linkedin className="w-5 h-5" /></a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-inter text-sm text-white/65">
              <li className="flex items-start gap-2"><MapPin className="w-4 h-4 text-or shrink-0 mt-0.5" /><span>Partout en France<br /><span className="text-white/40 text-xs">200+ partenaires équestres</span></span></li>
              <li className="flex items-center gap-2"><Mail className="w-4 h-4 text-or shrink-0" /><a href="mailto:sarah.dabancens@sd-equicoaching.fr" className="hover:text-or transition-colors">sarah.dabancens@sd-equicoaching.fr</a></li>
              <li className="flex items-center gap-2"><Phone className="w-4 h-4 text-or shrink-0" /><a href="tel:+33643455145" className="hover:text-or transition-colors">06 43 45 51 45</a></li>
              <li className="flex items-center gap-2"><Clock className="w-4 h-4 text-or shrink-0" /><span>Lun – Ven, 9h – 18h</span></li>
            </ul>
          </div>
        </div>
